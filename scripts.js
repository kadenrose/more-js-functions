...
function addTheValues(param1, param2){
    if(isNaN(param1) || isNaN(param2)){
        addToPage("One or both of the parameters is not a number, when added they equal " + param1 + " " + param2);
    }else{
...
addTheValues(2, 8);
addTheValues(8, "TomFord");
addTheValues("FartsALot", 2);
addTheValues("Store", "Devin");
...
number = doubleMyNumber(5);

// and let's write that value to the page
addToPage("The current value of the number is " + number);
...
addToPage("The current value of the number is " + number);
addToPage("Number equals " + number + " doubleMyNumber is: " + doubleMyNumber (number));
addToPage("The current value of the number is " + number);
...
// function drawBox(numBox, numCols, numChar){
